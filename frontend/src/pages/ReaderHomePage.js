...
export default function ReaderHomePage() {
  ...
  return (
    ...
    >
      <Typography variant="h4" sx={{ mb: 4, fontWeight: 'bold', color: '#4e796b' }}>
        ...
        {items.map((item, index) => (
          <Paper
            ...
            sx={{
              ...
              alignItems: 'center',
              bgcolor: selected?.label === item.label ? 'rgb(102,178,160)' : 'white',
              color: selected?.label === item.label ? '#fff' : 'rgb(78,121,107)',
              borderRadius: 4,
              ...
              '&:hover': {
                ...
                boxShadow: 6,
                bgcolor: selected?.label === item.label ? 'rgb(102,178,160)' : 'rgb(245,250,248)',
              },
              textAlign: 'center',
              px: 2,
            }}
